...
<body>
    ...
    <!-- --------------db connect failure alert ----------------------->
    <?php
        if($_SESSION['db_connect_error'])
        {
    ?>
            <div class="alert alert-danger alert-dismissible fade show">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <p> DB Connection error .</p>
            </div>
    <?php        
        }
    ...
    <!-- --------------Check if logout is sucesssful ------>
    <!-- <?php
        if($_SESSION['logout_success'])
        {
    ?> -->
            <!-- <div class="alert alert-success alert-dismissible fade show">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    <!-- -------------------feedback submit successful message----------- -->
    <?php
        if($_SESSION['feedback_success'])
        {
    ?>
            <div class="alert alert-success alert-dismissible fade show">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    <!-- -------------------job apply successful message----------- -->
    <?php
        if($_SESSION['job_apply'])
        {
    ?>
            <div class="alert alert-success alert-dismissible fade show">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    <div class="no-margin">
        <div class="module">
            <h3>Introduction</h3>
            <div class="content">
                <p> Welcome to Career Configure. We understand that career challenges are unique and complex to all individuals.
                We are here to help you find yourself and realize your full potential. We help you choosing right career path, 
                we help you explore more in your existing field.</p>
            </div>
        </div>
    </div>
    ...
    <div class="bgimg-3">
        <div class="caption">
            <span class="border-none">GET EMPOWERED WITH CAREER CONFIGURE</span>
        </div>
    </div>
       
    <!-- <div class="youtube-video">
        <iframe
            src="https://youtu.be/m9DDH_iB3qM">
        </iframe> 
    </div> -->
