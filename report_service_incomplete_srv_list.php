...
<html lang="en">
<head>
    <title>Incomplete Service</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="css/report_service_incomplete_srv_list.css">
...
<bodys>
    ...
    ?>
                    ...
                    <form action="report_service_mark_complete_srv_db.php" method="post" class="srv-mark-complete-form">
                    
                        <h3 class="incomp-srv-heading">Incomplete Service details</h3>
                        <div class="form-group">
                            ...
                            <div class="form-value">
                                <input type="text" value="<?php echo $row['service_id'] ?>" name="service_id">
                            </div>                                                        
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-value">
                                <input type="text" value="<?php echo $row['service_type'] ?>" >
                            </div>
                        ...
                        <div class="mark-comp-form-btn">
                            <button type="submit" class="btn btn-primary" name="upd-srv-submit-btn">Mark Complete</button>
                        </div>
    ...
    <div class="srv-home-link-bottom">
